...
<div class="container">
        <div class="wrapper">
               ...
               <table class="table table-hover"> 
                   <tr>
                       <td>First Name</td>
                       <td><input class="form-control" type="text" name="first-name" placeholder="enter client first name" required></td>
                       
                   </tr>
                   <tr>
                       <td>Middle Name</td>
                       <td><input class="form-control" type="text" name="mid-name" placeholder="enter client middle name" required></td>
                       
                   </tr>
                   <tr>
                       <td>Third Name</td>
                       <td><input class="form-control" type="text" name="third-name" placeholder="enter client third name" required></td>
                       
                   </tr>
                   <tr>
                       <td>Last Name</td>
                       <td><input class="form-control" type="text" name="last-name" placeholder="enter client last name" required></td>
                   ...
                   <tr>
                       <td>Gender</td>
                       <td><input class="form-control" type="text" name="gender" placeholder="enter client gender"required></td>
                       
                   </tr>
                   <tr>
                       <td>Birthdate</td>
                       <td><input class="form-control" type="date" name="birthdate" placeholder="Pick a date" required></td>
                       
                   </tr>
                   <tr>
                       <td>Status</td>
                       <td><input class="form-control" type="text" name="status" placeholder="enter status" required></td>
                       
                   </tr>
                   <tr>
                       <td>Phone</td>
                       <td><input class="form-control" type="text" name="phone" placeholder="enter client phone" required></td>
                       
                   </tr>
                   <tr>
                       <td>Type</td>
                       <td><input class="form-control" type="text" name="type" placeholder="enter client type" required></td>
...
if(isset($_POST['submit']))
{
    ...
    $sql2 = "SELECT phone FROM clients WHERE phone='$phone'" ;
    $res2 = sqlsrv_query($con ,$sql2);
    if($res2==true){
        $count2 = sqlsrv_has_rows($res2) ;
    if($count2>0)
     {
        $_SESSION['exist'] = "<div class='text-danger'>Client already exist.</div>" ;
    $script = "<script>
...
if($res==true){
      ...
      // failed 
      // creat session value for display the message
      $_SESSION['not-add'] = "<div class='text-danger'>Failed To Add Client</div>" ;
