        ...
        <button  style="background-color:#1565C0FF ;" name="find" class="btn btn-secondary my-2 my-sm-0" type="submit">Search</button>
              ...
              if (isset($_POST['find'])) {
               ...
               if (str_contains($id, '77')) {
                 ...
                 $sql = "SELECT * FROM transactions WHERE affectedId= $searchedClient";
                 $res = sqlsrv_query($con,$sql) ;
                       ...
                       while ($row = sqlsrv_fetch_array($res)) {
                          ...
                          if($status==1){
                             ...
                             foreach ($accountsArray as $accountId => $clientId) {
                                 ...
                                 <a style='background-color:green; padding 10px' class='btn btn-primary'  href='changeStatusProccess.php?id=$id&servicePointId=$servicePointId' title=''>Recieve</a>
                                 <div>
