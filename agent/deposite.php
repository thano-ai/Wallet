            ...
            if ($count > 0) {
               ...
               if ($res == true) {
                  ...
                  if ($count > 0) {
                     ...
                     echo '  <tr>
                 <td colspan="6">
                    <div class="text-danger">No Remittance Found</div>
                 </td>
              </tr>';
                  }
               }
...
<select name='type' style='width:100%; height:6%;font-size:15px;margin-left:-70%' class='form-select form-select-lg mb-6' aria-label='.form-select-lg example'>
  ...
  <button style="background-color:#1565C0FF ;" name="" class="btn btn-secondary my-2 my-sm-0" type="submit">Confirm</button>
