...
if(isset($_POST['submit'])){
    ...
    //create sql query
    $sql ="SELECT * FROM servicePoints WHERE ServicePointId=$id AND password='$current_pass'" ;
    ...
    if($res==true){
        ...
        if($count==1){
            ...
            //update the pass
            $sql2 = "UPDATE servicePoints SET password = '$new_pass' WHERE ServicePointId = $id" ;
